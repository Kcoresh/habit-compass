...
from habit_compass.cli import main
from habit_compass.models import Note, ProjectState, Task
from habit_compass.cli import demo_state
from habit_compass.storage import load_state, save_state
from habit_compass.models import generate_short_id
from habit_compass.validation import normalize_tags, require_text, validate_task_status
from habit_compass.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
